 ...
 * Log burning assumes ~1485 logs/hr at GE (wiki focused rate).
 * Wintertodt excluded — activity multi-reward structure.
 */
...
const LOGS_PER_HOUR = 1485; // wiki assumed GE burning rate
...
export const FIREMAKING_METHODS: FiremakingMethod[] = [
  {
    ...
    level: 1,
    xp: 40,
    actionsPerHour: LOGS_PER_HOUR,
    inputs: [{ name: "Logs", qty: 1 }],
    output: null,
  },
  {
    id: "burn-oak",
  ...
  {
    id: "burn-rosewood",
    label: "Burn rosewood logs",
    level: 92,
    xp: 350, // similar high-end
    actionsPerHour: LOGS_PER_HOUR,
    inputs: [{ name: "Rosewood logs", qty: 1 }],
    output: null,
  },
];
