 ...
 * Focused / low-effort XP/h from https://oldschool.runescape.wiki/w/Pay-to-play_Woodcutting_training
 * Not 1.5-tick teak max.
 */
...
export const WOODCUTTING_METHODS: WoodcuttingMethod[] = [
  ...
  { id: "teak-logs", label: "Teak logs", level: 35, xp: 85, actionsPerHour: 1060, inputs: [], output: { name: "Teak logs", qty: 1 } },
  ...
  { id: "sulliusceps", label: "Sulliusceps", level: 65, xp: 127, actionsPerHour: 780, inputs: [], output: null },
  ...
  { id: "redwood-logs", label: "Redwood logs", level: 90, xp: 380, actionsPerHour: 170, inputs: [], output: { name: "Redwood logs", qty: 1 } },
