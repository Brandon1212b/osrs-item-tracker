...
export const FISHING_METHODS: FishingMethod[] = [
  ...
  // MMG Catching sharks: 17,600 XP → 160 sharks/h (90 at 76 up to ~170).
  { id: "shark", label: "Raw shark", level: 76, xp: 110, actionsPerHour: 160, inputs: [], output: { name: "Raw shark", qty: 1 } },
  { id: "leechfin", label: "Leechfin", level: 78, xp: 33.2, actionsPerHour: 3600, inputs: [], output: null },
  // MMG Catching anglerfish: 18,000 XP and 150 sandworms / 150 fish.
  { id: "anglerfish", label: "Raw anglerfish", level: 82, xp: 120, actionsPerHour: 150, inputs: [{ name: "Sandworms", qty: 1 }], output: { name: "Raw anglerfish", qty: 1 } },
